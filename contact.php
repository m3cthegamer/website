            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12 col-12">
                    <div class="banner_content" data-aos="fade-right">
                        ...
                        <p class="text-white">Kendinize en uygun çözümleri bulmak için bizimle iletişime geçin.</p>
                        <div class="box">
                            <span class="mb-0">Anasayfa</span><i class="first fa-regular fa-angle-right"></i><i class="second fa-regular fa-angle-right"></i><span class="mb-0 box_span">Bize Ulaşın</span>
                        </div> 
                    </div>
                </div> 
                ...
                <div class="contact_content" data-aos="fade-right">
                    ...
                    <div class="contact-box">
                        ...
                        <div class="box-content">
                            <h4>Lokasyon:</h4>
                            <p class="text-size-18">İzmir,Türkiye</p>
                        </div>
                    </div>
                    <div class="contact-box box-mb">
                        ...
                        <div class="box-content">
                            <h4 class="heading">Telefon Numaralarımız:</h4>
                            <p>
                                <a href="tel:+61383766284" class="text-decoration-none text text-size-18">(+90 5319266386)</a>
                            </p>
                            <p>
                                <a href="tel:+61383766284" class="text-decoration-none text text-size-18">(+90 5464537252)</a>
                            </p>
                            <p>
                                <a href="tel:+61383766284" class="text-decoration-none text text-size-18">(+90 5388497181)</a>
                            </p>
                            <p>
                            </p>
                        </div>
                    ...
                    <div class="contact-box">
                        ...
                        <div class="box-content">
                            ...
                            <p>
                                <a href="mailto:info@artelligence.com" class="text-decoration-none text-size-18">berkelmaci35@gmail.com</a>
                            </p>
                            <p>
                                <a href="mailto:info@artelligence.com" class="text-decoration-none text-size-18">cemozkan19@gmail.com</a>
                            </p>
                            <p>
                                <a href="mailto:artelligence@gmail.com" class="mb-0 text-decoration-none text-size-18">erenulusoy06@gmail.com</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                <div class="need-section">
                    <div class="need_content"> 
                        ...
                        <form action="info.php" id="contactpage" method="POST" action="./contact-form.php">
                            <div class="row">
                                <div class="col-12">
...
<div class="contact_map_section">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1563.0143441970597!2d27.128706155630212!3d38.41770188784591!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14bbd8e2301a9d67%3A0xc585c535e03c6abc!2s%C4%B0zmir%20Saat%20Kulesi!5e0!3m2!1str!2str!4v1714672719946!5m2!1str!2str"
...
<section class="footer-section">
    <div class="container">
                    ...
                    <div class="icon">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="text">
                                ...
                                <a class="mb-0 text text-decoration-none text-size-16">+90 5388497181</a></li>
                            <li class="text">
                                <i class="fa fa-envelope fa-icon footer-location"></i>
                                <a class="mb-0 text text-decoration-none text-size-16">berkelmaci35@gmail.com</a></li>
                            <li class="text">
        ...
        <div class="modal fade" id="messageNotSent" tabindex="-1" role="dialog" aria-labelledby="successModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="successModalLabel">İşlem Başarısız</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Kapat">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
if (isset($_GET['modal_id']) && $_GET['modal_id'] == 'messageSent') {
    showModal('messageSent');
}
if (isset($_GET['modal_id']) && $_GET['modal_id'] == 'messageNotSent') {
    showModal('messageNotSent');
}
